...
data_root = '/home/openinnolab/work/current/mmyolo/data/event/dataset/'
...
launcher = 'none'
load_from = 'work_dirs/yolov5_s-v61_fast_1xb12-40e_cat/work_dirs/yolov5_s-v61_fast_1xb12-40e_cat/epoch_120.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file=
    '/home/openinnolab/work/current/mmyolo/data/event/dataset/annotations/test.json',
    metric='bbox',
    proposal_nums=(
        100,
        1,
